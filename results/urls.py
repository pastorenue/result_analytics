...
from .views import add_result, compute_cgpa, result_list, upload_csv, grading_setting, result_by_student, import_data, export_excel, full_detail, overall_result
